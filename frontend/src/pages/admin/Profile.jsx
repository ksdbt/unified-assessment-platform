...
import { Card, Avatar, Input, Button, Tabs, Descriptions } from 'antd';
import { Formik } from 'formik';
import * as Yup from 'yup';
import {
    UserOutlined, MailOutlined, PhoneOutlined, HomeOutlined,
    SaveOutlined, EditOutlined, CloseOutlined, SafetyCertificateOutlined
                    ...
                    {!isEditing ? (
                        <div className="space-y-6 animate-fadeIn">
                            ...
                            <Descriptions bordered column={{ xxl: 2, xl: 2, lg: 2, md: 1, sm: 1, xs: 1 }}>
                                ...
                                <Descriptions.Item label="Address" span={2}>{user.profile?.address || 'Not provided'}</Descriptions.Item>
        ...
        <div className="p-6 max-w-5xl mx-auto space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-lg">Manage your administrator account</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-1">
                    <Card className="text-center shadow-lg border-0 h-full">
                        <Avatar size={140} src={user.avatar} icon={<SafetyCertificateOutlined />} className="mb-6 border-4 border-indigo-50 shadow-md bg-indigo-600" />
                        <h2 className="text-2xl font-bold mb-1 text-gray-800 dark:text-white">{user.name}</h2>
                        <div className="inline-block px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full text-sm font-semibold mb-6 capitalize">
                            {user.role}
                        </div>
