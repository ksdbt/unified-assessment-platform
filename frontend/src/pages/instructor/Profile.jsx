...
const ProfileSchema = Yup.object().shape({
  ...
  experience: Yup.number().positive('Must be positive').integer('Must be an integer'),
  address: Yup.string(),
          ...
          {!isEditing ? (
            <div className="space-y-6 animate-fadeIn">
              ...
              <Descriptions bordered column={{ xxl: 2, xl: 2, lg: 2, md: 1, sm: 1, xs: 1 }}>
                ...
                <Descriptions.Item label="Specialization">{user.profile?.specialization || 'Not provided'}</Descriptions.Item>
                <Descriptions.Item label="Experience">{user.profile?.experience ? `${user.profile.experience} years` : 'Not provided'}</Descriptions.Item>
                  ...
                  <form onSubmit={handleSubmit} className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <Input size="large" name="department" value={values.department} onChange={handleChange} prefix={<BookOutlined className="text-gray-400" />} />
                      </div>

                      <div>
                        <label className="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Specialization</label>
                        <Input size="large" name="specialization" value={values.specialization} onChange={handleChange} />
                      </div>

                      <div>
                        <label className="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Experience (years)</label>
                        <Input size="large" name="experience" type="number" value={values.experience} onChange={handleChange} status={errors.experience && touched.experience ? 'error' : ''} />
                        {errors.experience && touched.experience && <div className="text-red-500 text-sm mt-1">{errors.experience}</div>}
                      </div>
